...
{	
	...
	/**
	 * Flash性能检测类
	 * @From http://code.google.com/p/mrdoob/source/browse/trunk/libs/net/hires/debug/Stats.as
	 * @author cuiyi
	 */
	/**
	 * Stats
	...
	{       
		...
		// Added by Trey, 显示FlashPlayer版本信息
		 ...
		 */
		public function FlashStats( _theme:Object = null ):void
		{
			if (_theme)
			{
			...
			graph = new Bitmap();
			graph.y = 50;
			// Modified by Trey, 2011-08-08, 先屏蔽图表显示
			graph.visible = false;
			
			rectangle = new Rectangle( WIDTH - 1, 0, 1, HEIGHT - 50 );                  
			
			// Added by Trey, 将原有FlashPlayer版本号信息内容还原
			ver = new Sprite();     
			ver.graphics.beginFill(0x33);
			ver.graphics.drawRect(0, 0, WIDTH, 30);
...
//			graphics.drawRect(0, 0, WIDTH, HEIGHT);
		...
		private function update(e:Event):void
		{
			...
			{
				ms_prev = timer;
				mem = Number((System.totalMemory * 0.000000954).toFixed(3));	// 以M为单位
